  ...
  return (
    <div className="pt-4 flex flex-col justify-bewtween h-full  w-full">
      ...
      <Image
        ...
        width={300}
        height={300}
        className="lg:w-48 w-32  hidden md:block "
      />
      </div>
      ...
      <div className="flex gap-4 items-center lg:px-6 px-0">
          <GoHome size={30} color="#666" />
          <p className="font-poppins text-xl font-medium text-[#666] hidden lg:block">Home</p>
        </div>
      </div>
        ...
        <div  className="flex gap-4 items-center  lg:px-6 px-0">
          ...
          <p className="font-poppins text-xl font-medium  hidden lg:block">Movies</p>
        </div>
        </div>
      ...
      <div className="flex gap-4 items-center lg:px-6 px-0">
          ...
          <p className="font-poppins text-xl font-medium  whitespace-nowrap  hidden lg:block">TV Series</p>
        </div>
      </div>
      ...
      <div className="flex gap-4 items-center lg:px-6 px-0">
        <Image src="/calendar.svg" alt="tv show" width={300} height={300} className="w-8"/>
          <p className="font-poppins text-xl font-medium  hidden lg:block">Upcoming</p>
        </div>
      </div>

      </div>

      <div  className="lg:flex flex-col px-3 mx-6 pt-10 pb-4 gap-2   rounded-[1.25rem] border solid border-[rgba(190,18,60,0.70)] bg-[rgba(248,231,235,0.4)]  hidden">
